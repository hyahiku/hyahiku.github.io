...
## 📂 Projects
---
### 🏥 AI Regional Healthcare Coordination Platform
> Healthcare Analytics · Geospatial Visualization · Scenario Modeling · International Group Collaboration
Data analysis supporting an AI-powered healthcare coordination platform concept for South Korea — built around three pillars: AI patient navigation (LLM-based triage), real-time hospital matching, and smart EMR exchange. Engineered a need-adjusted physician density index (doctors per 1,000 ÷ relative 65+ population burden), min-max scaled 0–1 across all provinces, and rendered as paired choropleth maps comparing current accessibility against a 30% gap-closure projection with 15/30/45% sensitivity analysis. Findings presented on an A0 research poster with a four-member international team.
| | |
|---|---|
